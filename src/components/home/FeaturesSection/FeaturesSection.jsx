...
// SVG Icon for Money Back Guarantee (Shield)
const GuaranteeIcon = () => (
 <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40" fill="none">
  <path d="M19.9834 2.58789C21.0049 2.58789 22.0044 2.73712 22.7578 3.01855L31.0752 6.13574H31.0762C33.2957 6.96251 35.0508 9.5081 35.0508 11.8672V24.25C35.0508 25.3372 34.7066 26.5899 34.124 27.749C33.578 28.8353 32.8406 29.8029 32.0312 30.4561L31.8682 30.583L24.7012 35.9326L24.6953 35.9375C23.4126 36.9266 21.724 37.4336 20 37.4336C18.2773 37.4335 16.5849 36.9268 15.2646 35.9482H15.2637L8.09961 30.5996C7.2269 29.9489 6.42556 28.9213 5.84277 27.7598C5.25993 26.5981 4.91699 25.3452 4.91699 24.2666V11.8672C4.91699 9.50798 6.67193 6.96238 8.8916 6.13574H8.89258L17.209 3.01855C17.9624 2.73704 18.9618 2.58792 19.9834 2.58789ZM20.001 4.08594C19.2024 4.08812 18.3755 4.19536 17.7422 4.43164L17.7412 4.43262L9.4248 7.54883H9.42383C8.59633 7.86042 7.85509 8.52294 7.32422 9.29102C6.79314 10.0594 6.43359 10.9903 6.43359 11.8838V24.2666C6.43359 25.1611 6.74417 26.1898 7.20117 27.1016C7.65805 28.0131 8.29341 28.8731 9.00098 29.4014L16.168 34.751C17.2298 35.5449 18.6284 35.9257 20.002 35.9258C21.3759 35.9258 22.7782 35.5447 23.8477 34.752L23.8496 34.751L31.0156 29.4014L31.0166 29.4004C31.7314 28.8643 32.3669 28.0054 32.8223 27.0947C33.2776 26.1841 33.584 25.16 33.584 24.2666V11.8672C33.584 10.9811 33.2236 10.0543 32.6934 9.28711C32.1628 8.51956 31.4223 7.85435 30.5977 7.53418L30.5928 7.53223L22.2754 4.41504L22.2666 4.41211C21.6285 4.18691 20.8004 4.08376 20.001 4.08594Z" fill="#FAFAFA" stroke="#FAFAFA"/>
  <path d="M24.4043 14.7695C24.6924 14.4818 25.1759 14.4816 25.4639 14.7695C25.7518 15.0575 25.7516 15.541 25.4639 15.8291L18.2969 22.9961C18.1456 23.1474 17.9578 23.2158 17.7666 23.2158C17.5756 23.2157 17.3885 23.1472 17.2373 22.9961L14.5537 20.3125C14.2658 20.0244 14.2657 19.5409 14.5537 19.2529C14.8417 18.9649 15.3252 18.9651 15.6133 19.2529L17.7666 21.4062L18.1211 21.0527L24.4043 14.7695Z" fill="#FAFAFA" stroke="#FAFAFA"/>
</svg>
);

// FeatureCard component to avoid repetition
const FeatureCard = ({ icon, title, description }) => (
  <div className="flex flex-col items-center text-center p-3 sm:p-4 md:p-6 w-full max-w-xs">
    <div className="flex items-center justify-center h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 rounded-full bg-blue-500 mb-4">
      <span className="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 flex items-center justify-center">{icon}</span>
    </div>
    <h3 className="font-bold text-gray-800 tracking-wider uppercase mb-2 text-base sm:text-lg md:text-xl">
      {title}
    </h3>
  ...
  return (
    <section className="bg-white py-8 sm:py-12 md:py-20">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 md:px-6 lg:px-8">
        <div className="grid grid-cols-1 xs:grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-8 md:gap-12 items-stretch justify-items-center">
