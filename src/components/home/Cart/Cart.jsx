...
const Cart = ({ isCartOpen, toggleCart }) => {
  ...
  return (
    <>
      {/* ... (your existing blur overlay and cart sidebar code remains the same) ... */}
      <div
      ...
      >
        {/* ... (your existing header and items container code remains the same) ... */}
        ...
        {cartItems.length > 0 && (
          <div className="p-5 border-t bg-white/80 backdrop-blur-sm">
            {/* ... (your subtotal, shipping, total info) ... */}
            ...
            <div className="flex gap-3 mt-4">
              ...
              <Link href="/checkout" className="w-full">
                <button 
                  onClick={toggleCart} // This closes the cart when you navigate
                  className="w-full bg-blue-600 text-white rounded-lg px-4 py-3 text-sm font-semibold hover:bg-blue-700 transition shadow-sm">
                  Checkout
                </button>
              </Link>
              {/* ▲▲▲▲▲ THE ONLY CHANGE IS HERE ▲▲▲▲▲ */}
