      ...
      >
        ...
        >
          {flashSaleProducts.map((product) => (
            <div
              key={product.id}
              className="group relative flex-none w-64 p-4 mx-2 bg-white rounded-lg shadow hover:shadow-xl transition-shadow duration-300"
            >
              ...
              <div className="text-center">
                <Link href={`/product/${product.id}`}>
                  <h3 className="text-[16px] font-semibold mb-1 truncate text-gray-800 hover:text-blue-600 transition-colors">
                    {product.name}
                  </h3>
                </Link>
